...
exports['ios-Default-Landscape-Store'] = {
	type: 'splash',
	path: path.join(':assets:', 'iphone', 'Default-Landscape-Store.png'),
	localePath: path.join('i18n', ':locale:', 'Default-Landscape-Store.png'),
	width: 2732,
	height: 2008,
	heightFix: 2048,
	platforms: ['ipad'],
