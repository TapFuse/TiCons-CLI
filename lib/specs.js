...
exports['android-MarketplaceArtworkPromo'] = {
	type: 'splash',
	path: path.join('MarketplaceArtworkPromo.png'),
	alsoNine: true,
	width: 180,
	height: 120,
	platforms: ['android']
...
exports['android-MarketplaceArtworkPhone'] = {
	type: 'splash',
	path: path.join('Android Phone 0.png'),
	alsoNine: true,
	width: 824,
	height: 1464,
	platforms: ['android']
...
exports['android-MarketplaceArtwork7'] = {
	type: 'splash',
	path: path.join('Android Tablet - 7inch -0.png'),
	alsoNine: true,
	width: 1920,
	height: 1200,
	platforms: ['android']
...
exports['android-MarketplaceArtwork10'] = {
	type: 'splash',
	path: path.join('Android Tablet - 10inch - 0.png'),
	alsoNine: true,
	width: 2560,
	height: 1600,
	platforms: ['android']
...
exports['android-appicon-ldpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-ldpi', 'appicon.png'),
	size: 36,
	alpha: true,
...
exports['android-appicon-mdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-mdpi', 'appicon.png'),
	size: 48,
	alpha: true,
	dpi: constants.dpi.mdpi,
	platforms: ['android']
...
exports['android-appicon-hdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-hdpi', 'appicon.png'),
	size: 72,
	alpha: true,
...
exports['android-appicon-xhdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-xhdpi', 'appicon.png'),
	size: 96,
	alpha: true,
	dpi: constants.dpi.xhdpi,
	platforms: ['android']
...
exports['android-appicon-xxhdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-xxhdpi', 'appicon.png'),
	size: 144,
	alpha: true,
	dpi: constants.dpi.xxhdpi,
	platforms: ['android']
...
exports['android-appicon-xxxhdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-xxxhdpi', 'appicon.png'),
	size: 192,
	alpha: true,
...
exports['android-default-long-land-xxxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-land-xxxhdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-land-xxxhdpi', 'default.png'),
	width: 1920,
	height: 1280,
	dpi: constants.dpi.xxxhdpi,
	platforms: ['android'],
...
exports['android-default-long-land-xxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-land-xxhdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-land-xxhdpi', 'default.png'),
	width: 1600,
	height: 960,
	dpi: constants.dpi.xxhdpi,
	platforms: ['android'],
...
exports['android-default-long-land-xhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-land-xhdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-land-xhdpi', 'default.png'),
	width: 960,
	height: 640,
	dpi: constants.dpi.xhdpi,
	platforms: ['android'],
...
exports['android-default-long-land-hdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-land-hdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-land-hdpi', 'default.png'),
	width: 800,
	height: 480,
	dpi: constants.dpi.hdpi,
	platforms: ['android'],
...
exports['android-default-long-land-mdpi'] = { // missing in docs and needed because mdpi default is portrait
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-land-mdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-land-mdpi', 'default.png'),
	width: 480,
	height: 320,
	dpi: constants.dpi.mdpi,
	platforms: ['android'],
...
exports['android-default-long-land-ldpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-land-ldpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-land-ldpi', 'default.png'),
	width: 400,
	height: 240,
	dpi: constants.dpi.ldpi,
	platforms: ['android'],
...
exports['android-default-long-port-xxxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-port-xxxhdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-port-xxxhdpi', 'default.png'),
	width: 1280,
	height: 1920,
	dpi: constants.dpi.xxxhdpi,
	platforms: ['android'],
...
exports['android-default-long-port-xxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-port-xxhdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-port-xxhdpi', 'default.png'),
	width: 960,
	height: 1600,
	dpi: constants.dpi.xxhdpi,
	platforms: ['android'],
...
exports['android-default-long-port-xhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-port-xhdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-port-xhdpi', 'default.png'),
	width: 640,
	height: 960,
	dpi: constants.dpi.xhdpi,
	platforms: ['android'],
...
exports['android-default-long-port-hdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-port-hdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-port-hdpi', 'default.png'),
	width: 480,
	height: 800,
	dpi: constants.dpi.hdpi,
	platforms: ['android'],
...
exports['android-default-long-port-mdpi'] = { // missing in docs and needed for locale
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-port-mdpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-port-mdpi', 'default.png'),
	width: 320,
	height: 480,
	dpi: constants.dpi.mdpi,
	platforms: ['android'],
...
exports['android-default-long-port-ldpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'res-long-port-ldpi', 'default.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-long-port-ldpi', 'default.png'),
	width: 240,
	height: 400,
	dpi: constants.dpi.ldpi,
	platforms: ['android'],
...
exports['android-res-xxxhdpi'] = {
	type: 'asset',
	path: path.join(':assets:', 'android', 'res-xxxhdpi'),
	dpi: constants.dpi.xxxhdpi,
	platforms: ['android']
};
exports['android-res-xxhdpi'] = {
	type: 'asset',
	path: path.join(':assets:', 'android', 'res-xxhdpi'),
	dpi: constants.dpi.xxhdpi,
	platforms: ['android']
};
exports['android-res-xhdpi'] = {
	type: 'asset',
	path: path.join(':assets:', 'android', 'res-xhdpi'),
	dpi: constants.dpi.xhdpi,
	platforms: ['android']
};
exports['android-res-hdpi'] = {
	type: 'asset',
	path: path.join(':assets:', 'android', 'res-hdpi'),
	dpi: constants.dpi.hdpi,
	platforms: ['android']
};
exports['android-res-mdpi'] = {
	type: 'asset',
	path: path.join(':assets:', 'android', 'res-mdpi'),
	dpi: constants.dpi.mdpi,
	platforms: ['android']
};
exports['android-res-ldpi'] = {
	type: 'asset',
	path: path.join(':assets:', 'android', 'res-ldpi'),
	dpi: constants.dpi.ldpi,
	platforms: ['android']
};
