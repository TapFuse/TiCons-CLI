...
exports['android-icon-mdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-mdpi', 'icon.png'),
	size: 48,
	alpha: true,
	dpi: constants.dpi.mdpi,
	platforms: ['android']
...
exports['android-icon-hdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-hdpi', 'icon.png'),
	size: 72,
	alpha: true,
...
exports['android-icon-xhdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-xhdpi', 'icon.png'),
	size: 96,
	alpha: true,
	dpi: constants.dpi.xhdpi,
	platforms: ['android']
...
exports['android-icon-xxhdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-xxhdpi', 'icon.png'),
	size: 144,
	alpha: true,
	dpi: constants.dpi.xxhdpi,
	platforms: ['android']
...
exports['android-icon-xxxhdpi'] = {
	type: 'icon',
	path: path.join(':assets:', 'android', 'drawable-xxxhdpi', 'icon.png'),
	size: 192,
	alpha: true,
...
exports['android-screen-drawable-land-xxxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-land-xxxhdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-land-xxxhdpi', 'screen.png'),
	width: 1920,
	height: 1280,
	dpi: constants.dpi.xxxhdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-land-xxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-land-xxhdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-land-xxhdpi', 'screen.png'),
	width: 1600,
	height: 960,
	dpi: constants.dpi.xxhdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-land-xhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-land-xhdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-land-xhdpi', 'screen.png'),
	width: 960,
	height: 640,
	dpi: constants.dpi.xhdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-land-hdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-land-hdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-land-hdpi', 'screen.png'),
	width: 800,
	height: 480,
	dpi: constants.dpi.hdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-land-mdpi'] = { // missing in docs and needed because mdpi screen is portrait
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-land-mdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-land-mdpi', 'screen.png'),
	width: 480,
	height: 320,
	dpi: constants.dpi.mdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-port-xxxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-port-xxxhdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-port-xxxhdpi', 'screen.png'),
	width: 1280,
	height: 1920,
	dpi: constants.dpi.xxxhdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-port-xxhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-port-xxhdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-port-xxhdpi', 'screen.png'),
	width: 960,
	height: 1600,
	dpi: constants.dpi.xxhdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-port-xhdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-port-xhdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-port-xhdpi', 'screen.png'),
	width: 640,
	height: 960,
	dpi: constants.dpi.xhdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-port-hdpi'] = {
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-port-hdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-port-hdpi', 'screen.png'),
	width: 480,
	height: 800,
	dpi: constants.dpi.hdpi,
	platforms: ['android'],
...
exports['android-screen-drawable-port-mdpi'] = { // missing in docs and needed for locale
	type: 'splash',
	path: path.join(':assets:', 'android', 'drawable-port-mdpi', 'screen.png'),
	localePath: path.join(':assets:', 'android', 'res-:locale:-drawable-port-mdpi', 'screen.png'),
	width: 320,
	height: 480,
	dpi: constants.dpi.mdpi,
	platforms: ['android'],
